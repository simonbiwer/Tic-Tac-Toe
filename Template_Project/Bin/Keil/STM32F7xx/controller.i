...
class Field{
	...
	public:
		...
		void draw(cDevDisplayGraphic disp){

			  disp.setBackColor(cHwDisplayGraphic::Navy);
				disp.clear();
				disp.drawFrame(100,300,200,100,2, cHwDisplayGraphic::Red);

		}
};


#line 5 "Controller.cpp"
