...
*/
//*****************************************************************************
class cHwEthernet_EMAC: public cHwEthernet
{
	public:
	  cHwEthernet_EMAC( const cNetAddr<6> &addrPhyIn );
  ...
  private:
    ...
    void delay(void);
	  uint8_t ReadOp(uint8_t op, uint8_t address);
		...
		void WriteWord(uint8_t address, WORD data);
...
void output_MDIO (unsigned int val, unsigned int n);
void turnaround_MDIO (void);
unsigned int input_MDIO (void);
